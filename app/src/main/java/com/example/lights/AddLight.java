    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        saveLight.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String url = networkHandler.makeUrl("lights/add", "serial="+serial.getText(), "user_id="+userId);
                ...
                StringRequest stringRequest = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        if(response.equals("Saved")){
                            ...
                            Toast.makeText(v.getContext(),"Niepoprawny login lub hasło! Spróbuj ponownie!", Toast.LENGTH_LONG).show();
                        }
                    }
